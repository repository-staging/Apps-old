...
class PackageManagerHelper {
    ...
    fun install(context: Context, apkFile: List<File>): Int {
        return installApks(context, apkFile.toPaths())
    }
    ...
    private fun installApks(context: Context, files: Array<String>): Int {
